    ...
    private void whenValueFilled(){
        ...
        if(tmp != null && tmp.matches("^[-+]?[0-9]+")){
            ...
            if(fromWhat.equals(toWhat)) output.setText(tmp);
                ...
                String res = Integer.toString(result);
                output.setText(res);
            }else if(fromWhat.equals("Fahrenheit") && toWhat.equals("Kelvin")){
                double tmpNumber2 = tmpNumber;
                double tempResult = (tmpNumber2 + 460)*0.56; //(T(°F) + 459.67)× 5/9);
                int result = (int) tempResult;
                String res = Integer.toString(result);
                output.setText(res);
            }else if(fromWhat.equals("Kelvin") && toWhat.equals("Fahrenheit")){
                double tmpNumber2 = tmpNumber;
                Double tempResult = ((tmpNumber2 * 1.8) - 460); //T(°F) = T(K) × 9/5 - 459.67
